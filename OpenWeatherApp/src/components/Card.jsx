...
const Card = ({loadingData, showData, weather, forecast }) => {
    ...
    if(showData){
        ...
        iconUrl9 = url + forecast.list[33].weather[0].icon + ".png";
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/13739807/pexels-photo-13739807.jpeg" className='img-fluid rounded-start' alt='city' />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-2">
                                        <h5 className='card-text'>Max Temperature : {(weather.main.temp_max - 273.15).toFixed(1)} </h5>
                                        <h5 className='card-text'>Min Temperature : {(weather.main.temp_min - 273.15).toFixed(1)} </h5>
                                        <h5 className='card-text'>Feels like : {(weather.main.feels_like - 273.15).toFixed(1)} </h5>
